...
#define ch1offset 19 //-6 //7
#define ch0offset 20 //-11 //7

#define CH0_ADCoffset 1;
#define CH1_ADCoffset 1;

#define CH0_gain_err 0.98;
#define CH1_gain_err 0.98;

#define CH0_ADCoffset_G0 1.02;
#define CH0_ADCoffset_G1 1.002;
#define CH0_ADCoffset_G2 1.004;
#define CH0_ADCoffset_G3 1;

#define CH1_ADCoffset_G0 1.012;
#define CH1_ADCoffset_G1 1.002;
#define CH1_ADCoffset_G2 0.996;
#define CH1_ADCoffset_G3 1;
